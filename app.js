...
const apiKey = "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";
...
form.addEventListener("submit", async (e) => {
  ...
  let chatbotResponse = ""; // Define chatbotResponse here
  let yes = 0;
  ...
  const str_pos0 = message.indexOf("code");
  const str_pos1 = message.indexOf("Code");
  const str_pos2 = message.indexOf("program");
  const str_pos3 = message.indexOf("Program");
  const str_pos4 = message.indexOf("letter");
  const str_pos5 = message.indexOf("Letter");
